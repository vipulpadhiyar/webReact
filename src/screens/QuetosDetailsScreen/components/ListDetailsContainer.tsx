...
interface ListDetailsContainerItemProps {
...
/**
 * `ListDetailsContainer` is a component that displays a label and a corresponding value in a styled container.
 *
 * @param {ListDetailsContainerItemProps} props - The properties for the `ListDetailsContainer` component.
 ...
 *
 * @returns {React.JSX.Element} The `ListDetailsContainer` component.
 */
export const ListDetailsContainer = memo(
  (props: ListDetailsContainerItemProps): React.JSX.Element => {
